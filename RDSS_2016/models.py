...
class Company(AbstractBaseUser):
	...
	cid = models.CharField(u'公司統一編號',unique=True,max_length=8,primary_key=True)
	...
	brief = models.CharField(u'公司介紹',max_length=110)
	introduction = models.CharField(u'公司簡介',max_length=260)
	...
	logo=models.ImageField(u"公司LOGO",upload_to = 'logos',null=True,help_text='''網站展示、筆記本內頁公司介紹使用，僅接受 jpg, png, gif 格式。建議解析度為 300 dpi以上，以達到最佳效果。''')
