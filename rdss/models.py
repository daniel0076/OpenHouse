...
class CompanySurvey(models.Model):
	...
	#ability
	professional_skill_rate	= models.CharField(u'專業知能',max_length=4,choices=RATING)
	foreign_lang_rate		= models.CharField(u'外語能力',max_length=4,choices=RATING)
	document_process_rate	= models.CharField(u'文書處理',max_length=4,choices=RATING)
	info_literacy_rate		= models.CharField(u'資訊素養',max_length=4,choices=RATING)
	problem_solving_rate	= models.CharField(u'發現及解決問題',max_length=4,choices=RATING)
	attitude_rate			= models.CharField(u'工作態度',max_length=4,choices=RATING)
	civic_duty_rate			= models.CharField(u'公民責任',max_length=4,choices=RATING)
	pro_moral_rate			= models.CharField(u'專業倫理',max_length=4,choices=RATING)
	humanities_rate			= models.CharField(u'人文及在地關懷',max_length=4,choices=RATING)
	cultural_rate			= models.CharField(u'人文藝術陶冶',max_length=4,choices=RATING)
	international_view_rate	= models.CharField(u'國際視野',max_length=4,choices=RATING)
	diverse_thinking_rate	= models.CharField(u'跨界多元思考',max_length=4,choices=RATING)
	group_cognitive_rate		= models.CharField(u'群己平衡認知',max_length=4,choices=RATING)
